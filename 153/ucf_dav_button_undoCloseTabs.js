...
(function() {
    ...
    const
        ...
        btnImage = "list-style-image: url(data:image/png;base64,)",
		CLIKS = {
			left:0,
			middle:1,
			right:2
	...
	function _localize(sid) {
		var strings = {
			ru: {
				restoreTab:`
                      Left-Click: Восстановить вкладку
					  Middle-Click: Восстановить вкладку и открыть меню
					  Right-Click: Забыть вкладку
				`.replace(/^\n| {2,}|\t/g, ''),
			...
			tabContextMenuAccesskey: "о",
				...
				day: "d",
				whitoutData: "Нет данных"
			}
		};
		_localize = function(sid) {
			return strings.ru[sid] || sid;
		};
