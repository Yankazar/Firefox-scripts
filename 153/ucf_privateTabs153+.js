...
// ==/UserScript==
console.log("PrivateTabs: script started");

// Совместимость с xiao
UC = {
  createElement(doc, type, attrs) {
...
class PrivateTabManager {
  ...
  constructor() {
   ...
   let iconsSheet = Services.dirsvc.get("UChrm", Ci.nsIFile);
...
console.log("PrivateTabs: exec started");
if (location.href !== "chrome://browser/content/browser.xhtml") {
    console.log("PrivateTabs: not browser window, exit:", location.href);
    return;
}
console.log("PrivateTabs: step 1");
...
//
    ...
    let openAllPrivate = UC.createElement(document, "menuitem", {
      id: "openAllPrivate",
...
console.log("PrivateTabs: step 2");
...
//
    let openAllLinksPrivate = UC.createElement(document, "menuitem", {
...
console.log("PrivateTabs: step 3");
   ...
   let openPrivate = UC.createElement(document, "menuitem", {
      id: "openPrivate",
...
console.log("PrivateTabs: step 4");
...
window.addEventListener("keydown", e => {
    if (e.altKey && e.ctrlKey && e.key.toUpperCase() == "T") {
        window.privateTab.togglePrivate();
    }

    if (e.altKey && e.ctrlKey && e.key.toUpperCase() == "P") {
        window.privateTab.BrowserOpenTabPrivate();
    }
});

    let toggleKey = null;
    let newPrivateTabKey = null;

    console.log("PrivateTabs: step 5");

    let menuOpenLink = UC.createElement(document, "menuitem", {
...
console.log("PrivateTabs: step 6");
   ...
   let toggleTab = UC.createElement(document, "menuitem", {
...
if (privateMask) {
   if (privateMask) {
    ...
    console.log("PrivateTabs: private mask not found");
}


//
let btn2 = UC.createElement(document, "toolbarbutton", {
      id: this.BTN2_ID,
      label: "New Private Tab",
...
console.log("PrivateTabs: btn2 inserted");
...
//
console.log("PrivateTabs: before widget");

console.log("BEFORE CREATE WIDGET");

gBrowser.tabContainer._updateNewTabVisibility();
console.log("PrivateTabs: creating widget");
...
CustomizableUI.createWidget({
    ...
    onBuild: doc => {
        ...
        console.log("PrivateTabs: widget build");

        let btn = UC.createElement(doc, "toolbarbutton", {
            id: this.BTN_ID,
            label: "New Private Tab",
...
console.log("PrivateTabs: widget created");


//
console.log("AFTER CREATE WIDGET");
    console.log("PrivateTabs: widget created");
...
//
console.log("PrivateTabs: exec finished");
//
  }
...
let originalOpenTabset = lazy.PlacesUtils.openTabset;
...
console.log("PrivateTabs: initialized");